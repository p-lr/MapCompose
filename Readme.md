...
[![](https://img.shields.io/badge/ComposeBOM-2025.09.00-brightgreen)](https://developer.android.com/jetpack/compose/bom/bom)
...
```groovy
implementation 'ovh.plrapps:mapcompose:3.2.1'
```
