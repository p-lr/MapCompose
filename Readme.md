...
[![](https://img.shields.io/badge/Compose-1.2.1-brightgreen)](https://developer.android.com/jetpack/androidx/releases/compose-compiler)
...
```groovy
implementation 'ovh.plrapps:mapcompose:2.2.3'
```
