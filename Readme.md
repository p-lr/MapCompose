...
[![](https://img.shields.io/badge/ComposeBOM-2024.06.00-brightgreen)](https://developer.android.com/jetpack/compose/bom/bom)
...
```groovy
implementation 'ovh.plrapps:mapcompose:2.12.6'
```
